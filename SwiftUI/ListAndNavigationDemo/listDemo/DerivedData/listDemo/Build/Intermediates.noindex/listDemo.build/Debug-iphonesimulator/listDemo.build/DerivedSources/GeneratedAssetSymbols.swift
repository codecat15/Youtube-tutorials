...
extension ImageResource {
    ...
    static let ganeshJi = ImageResource(name: "GaneshJi", bundle: resourceBundle)
    ...
    static let sinhgad = ImageResource(name: "Sinhgad", bundle: resourceBundle)

    /// The "goi" asset catalog image resource.
    static let goi = ImageResource(name: "goi", bundle: resourceBundle)

    /// The "md" asset catalog image resource.
    static let md = ImageResource(name: "md", bundle: resourceBundle)
